...
def main():
    ...
    plt.xlabel('Noisy porportions (%)')
    plt.ylabel('Test Accuracy')
    plt.title('Accuracy vs. Noisy porportions')
...
#noisy proportions [0.25, 0.5, 0.75] (noise level: 0.5), Accuracies: [0.9977777777777778, 0.9985185185185185, 0.9977777777777778] (classes: 2, 14, 33, 34)