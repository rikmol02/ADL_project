...
def main():
    ...
    plt.xlabel('Proportion of Noisy Samples (%)')
...
#CNN (last conv layer removed & mlp reduced) proportion noisy [10, 25, 40%] (noise_level: 11%): Accuracies: [0.9896296296296296, 0.9977777777777778, 0.9955555555555555] (4 classes: 2, 14, 33, 34)

#CNN (last conv layer removed & mlp reduced) proportion noisy [25, 50, 75%] (noise_level: 50%): Accuracies: [0.9933333333333333, 0.9977777777777778, 0.9977777777777778] (4 classes: 2, 14, 33, 34)