...
#all 128x128    
#CNN (30 epochs) (8 classes, UNDERSAMPLED) -> accuracy: 0.96 (runtime: 15253 sec = 254 min.) (classes: 1, 12, 13, 14, 26, 33, 34, 40)

#CNN remove last Conv layer and reduce Dense layer (1 epochs) (4 classes, OVERSAMPLED) -> accuracy: 0.99 (runtime: 835 sec = 14 min.) (classes: 2 (!!!), 13, 33, 34)
#CNN remove last Conv layer and reduce Dense layer (20 epochs) (4 classes, OVERSAMPLED) -> accuracy: 1.0 (runtime: 16243 sec = 271 min.) (classes: 2 (!!!), 13, 33, 34)
