...
def main():
    ...
    for p in proportions:
        print()
        print(f"Noise data proportion: {p}")
    ...
    plt.xlabel('Proportion of Noisy Data (%)')
    plt.ylabel('Test Accuracy')
    plt.title('Accuracy vs. Proportion of Noisy Data')
...
#fraction [0.25, 0.5, 0.75] (noise level is 0.5) (20 epochs, 4 classes OVERSAMPLED) -> Accuracies: [0.9977777777777778, 1.0, 0.9992592592592593] (classes: [2, 14, 33, 34]) )
